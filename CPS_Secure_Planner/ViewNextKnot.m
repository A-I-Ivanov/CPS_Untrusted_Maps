...
xStart = [0,-.1, -pi/2, .5, 0]'; %Where and how fast am I going?
...
ub(controlIndex+1:nu:end) = 100; %%Bound the turn rate
lb(controlIndex+1:nu:end) = -100;


%Some options for the optimizer
opts = optimset('Display','iter','Algorithm','sqp', 'MaxIter', 100000, 'MaxFunEvals', 100000,'TolX', 1e-19);
