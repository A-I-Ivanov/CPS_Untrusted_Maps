...
if(solid)
 traj = plot(trajectory(2:(nx+nu):end), trajectory(3:(nx+nu):end), 'b');
    ...
    traj = quiver(trajectory(2:(nx+nu):end), trajectory(3:(nx+nu):end),u*quiverScale,v*quiverScale,'b','AutoScale','off');
